...
class WordleGame {
    ...
    static bool IsValidGuess(const string& guess, vector<string> guesses) {
    ...
    static void PrintGuess(const Status guessStatus[], const string& guess) {
...
public:
    ...
    explicit WordleGame(const string &givenWord) {
        word = givenWord;
    }
